...
//
//@Entity
//@Table(name = "old_reservations")
//public class OldReservation implements Comparable{
//
//    @Id
//    @GeneratedValue
//    @Column(name = "id")
...
//        OldReservation otherOldReservation = (OldReservation) o;
//        Date thisDate = setHourMinuteSecondMillisecondInZero(date);
//        Date otherDate = setHourMinuteSecondMillisecondInZero(otherOldReservation.date);
